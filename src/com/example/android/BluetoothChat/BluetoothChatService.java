...
public class BluetoothChatService {
	...
	public BluetoothChatService(Context context, Handler handler) {
		...
		mState = STATE_NONE;
		mHandler = handler;
		this.context = (BluetoothChat) context;
	}
	...
	private void connectionLost() {
		...
		final long result = stop - context.lastActionTime;

		context.runOnUiThread(new Runnable() {
			public void run() {
				if (context.lastActionTime != 0) {
					TextView currValLabel = (TextView) context.findViewById(R.id.currval);
					TextView currKeyLabel = (TextView) context.findViewById(R.id.currkey);
					currKeyLabel.setText("Reaction on disconnection");
